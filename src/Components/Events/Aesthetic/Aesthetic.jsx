    ...
    <div>
      <div className='top-back'>
        <div className='shadow'>
          <h1 className='top-heading'>Aesthetic Dentistry and Its Applications Conference</h1>
          <h3 className='top-para'>Theme – Innovating Beauty: Advancing Techniques and Technologies in Aesthetic Dentistry.</h3>
          <div className='logo-container'>
          <h3 className='date'><CalendarMonthRoundedIcon sx={{color:"red",fontSize:'50px'}}/><br/> Date:<br/>
          October 13-14, 2025</h3>
      ...
      <div className='mid-cont'>
        ...
        <h1>About Aesthetic Dentistry and Its Applications Conference</h1>
