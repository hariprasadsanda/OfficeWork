    ...
    <div>
      <div className='top-back'>
        <div className='shadow'>
          <h1 className='top-heading'>Modern Dentistry Conference</h1>
          <h3 className='top-para'>Theme –Redefining Dental Care: Innovations, Technology, and Patient-Centered Approaches</h3>
          <div className='logo-container'>
          <h3 className='date'><CalendarMonthRoundedIcon sx={{color:"red",fontSize:'50px'}}/><br/> Date:<br/>
          November 17-18, 2025</h3>
          <h3 className='venue'><RoomRoundedIcon  sx={{color:"red",fontSize:'50px'}}/><br/> Venue:<br/>
          Miami, Florida , USA</h3>
          </div>
          <div>
            <ul className='list'>
      ...
      <div className='mid-cont'>
        ...
        <h1>Modern Dentistry Conference</h1>
