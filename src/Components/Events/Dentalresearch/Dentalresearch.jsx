    ...
    <div>
      <div className='top-back'>
        <div className='shadow'>
          <h1 className='top-heading'>Dental Research and Oral Health Conference</h1>
          <h3 className='top-para'>Theme –Pioneering Innovations and Breakthroughs in Dental Research and Oral Health

</h3>
          <div className='logo-container'>
          <h3 className='date'><CalendarMonthRoundedIcon sx={{color:"red",fontSize:'50px'}}/><br/> Date:<br/>
          August 11-12, 2025</h3>
      ...
      <div className='mid-cont'>
        ...
        <h1>About Dental Research and Oral Health Conference</h1>
        <p><span className='class-span'>The American World Orthodontics Conference</span> scheduled for <span className='class-span'> November 17-18, 2025, in Dubai, UAE</span>remains the main occasion that unites orthodontic experts, specialists, and industry specialists. The Orthodontics Conference gives an unmistakable chance to dig into the most recent improvements in orthodontics, highlighting dynamic meetings that address progressed<span className='class-span'>treatment techniques, pivotal innovations </span> , and arising patterns inside the discipline.<br/> <br/>
