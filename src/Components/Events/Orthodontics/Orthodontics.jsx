    ...
    <div>
      <div className='top-back'>
        <div className='shadow'>
          <h1 className='top-heading'>American World Orthodontics Congress</h1>
          <h3 className='top-para'>Theme – Pioneering Smiles: Innovations, Integrations, and Future Directions in Orthodontics</h3>
      ...
      <div className='mid-cont'>
        ...
        <h1>About Neuroscience Conference</h1>
