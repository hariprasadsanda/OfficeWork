    ...
    <div>
      <div className='top-back'>
        <div className='shadow'>
          <h1 className='top-heading'>Dental Pharmacology Conference</h1>
          <h3 className='top-para'>Theme –Integrating Pharmacology for Enhanced Dental Care: From Drug Interactions to Pain Management</h3>
          <div className='logo-container'>
          <h3 className='date'><CalendarMonthRoundedIcon sx={{color:"red",fontSize:'50px'}}/><br/> Date:<br/>
          October 20-21, 2025</h3>
      ...
      <div className='mid-cont'>
        ...
        <h1>About Dental Pharmacology Conference
        </h1>
